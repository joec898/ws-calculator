...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.jctech.wssoup.service.CalculatorService {
    ...
    private java.lang.String CalculatorPort_address = "http://localhost:8888/cal";
    ...
    public com.jctech.wssoup.service.Calculator getCalculatorPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.jctech.wssoup.service.CalculatorPortBindingStub _stub = new com.jctech.wssoup.service.CalculatorPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.jctech.wssoup.service.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.jctech.wssoup.service.CalculatorPortBindingStub _stub = new com.jctech.wssoup.service.CalculatorPortBindingStub(new java.net.URL(CalculatorPort_address), this);
                _stub.setPortName(getCalculatorPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.wssoup.jctech.com/", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.wssoup.jctech.com/", "CalculatorPort"));
        }
